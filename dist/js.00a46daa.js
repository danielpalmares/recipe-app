 ...
 ***********> CONFIG VARIABLES
 ***************************************/
var randomAJAX = 'https://www.themealdb.com/api/json/v1/1/random.php';
var searchAJAX = 'https://forkify-api.herokuapp.com/api/v2/recipes';
var page = 1;
var resPerPage = 10;
/***************************************
 ***********> DOM CONTENT
...
var closePopupBtn = document.querySelector('.custom-card__close-button');
var popup = document.querySelector('.custom-card');
var okBtn = document.querySelector('.custom-card__start-button');
...
var sliceRecipes = function sliceRecipes(recipeArr, start, end) {
  var recipesSliced = recipeArr.slice(start, end);
  return recipesSliced;
};

var clearInputField = function clearInputField(inputEl) {
  inputEl.value = '';
};

var isIDinLocalStorage = function isIDinLocalStorage(id) {
  var strFromLS = state.storage.getItem('recipesID');
  var strFromLSParsed = JSON.parse(strFromLS);
  var arr = strFromLSParsed === null ? [] : strFromLSParsed;
  var checkID = arr.some(function (obj) {
    return obj.recID === id;
  });
  return checkID;
};
...
var getFavQuery = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    var res, resJSON, recipe;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("".concat(searchAJAX, "/").concat(id));
  ...
  return function getFavQuery(_x) {
    return _ref.apply(this, arguments);
  };
}();

var getQueryByID = /*#__PURE__*/function () {
  ...
  return function getQueryByID(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

var settingStorage = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(id) {
    var recipe, strFromLS, strFromLSParsed, arr, checkID;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return getFavQuery(id);
          ...
          case 2:
            ...
            strFromLS = state.storage.getItem('recipesID');
            strFromLSParsed = JSON.parse(strFromLS);
            arr = strFromLSParsed === null ? [] : strFromLSParsed;
            checkID = arr.some(function (obj) {
              return obj.recID === id;
            });
  ...
  return function settingStorage(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

var getSearchQuery = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(id, handler) {
    var res, resData, recipes;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            handler();
            _context4.next = 4;
            return fetch("".concat(searchAJAX, "?search=").concat(id));
  ...
  return function getSearchQuery(_x4, _x5) {
    return _ref4.apply(this, arguments);
  };
}();

var getRandomQuery = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    var res, resJSON, data, key;
  ...
  return function getRandomQuery() {
...
var removeBtn = function removeBtn() {
  var btn = document.querySelector('#show-more');
  if (btn === null) return;
  btn.parentNode.removeChild(btn);
};

var renderNoRecMsg = function renderNoRecMsg() {
...
var renderRecipesBySearch = function renderRecipesBySearch(recipesArr, page, position) {
  var curPage = (page - 1) * 10;
  var maxPage = page * 10;
  var recipesNewArr = sliceRecipes(recipesArr, curPage, maxPage);
  recipesNewArr.map(function (rec) {
    var recObj = {
      id: rec.id,
    ...
    var isIDinLS = isIDinLocalStorage(recObj.id);
    var recipeMarkup = "\n      <div class=\"recipe-container\">\n        <div class=\"recipe-container__image-container noSelect\">\n          <img\n            src=\"".concat(recObj.image, "\"\n            class=\"recipe-container__image\"\n            id=\"recipe-image\"\n            alt=\"Recipe photo\"\n            data-id=\"").concat(recObj.id, "\"\n          />\n        </div>\n\n        <div class=\"recipe-container__info\">\n          <div class=\"recipe-container__name-fav\">\n            <span class=\"recipe-container__name\">").concat(recObj.title, "</span>\n\n            <button class=\"recipe-container__fav-button noSelect\">\n              <svg class=\"").concat(!isIDinLS ? 'icon recipe-container__fav-icon-heart-inactive' : 'icon recipe-container__fav-icon-heart-active', "\">\n                <use xlink:href=\"./img/sprite.svg#icon-heart\" class=\"svg-path\"></use>\n              </svg>\n            </button>\n          </div>\n        </div>\n      </div>\n    ");
    recipeSection.insertAdjacentHTML("".concat(position), recipeMarkup);
  });
};

var renderRecInfo = function renderRecInfo(el) {
  var container = el;
  var ingredients = state.searchByID.recipe.ingredients;
  var recInfoMarkup = "\n    <div class=\"recipe-ingredients\">\n      <h3 class=\"heading-tertiary recipe-ingredients__title\">\n        Recipe ingredients\n      </h3>\n\n      <ul class=\"recipe-ingredients__list\">\n        ".concat(ingredients.map(function (ing) {
    return "\n            <li class=\"recipe-ingredients__ingredient\">\n              <div class=\"recipe-ingredients__wrapper\">\n                <svg class=\"icon recipe-ingredients__icon-check\">\n                  <use xlink:href=\"./img/sprite.svg#icon-check\"></use>\n                </svg>\n                <div class=\"recipe-ingredients__quantity\">".concat(ing.quantity === null ? '' : ing.quantity, "</div>\n                <span class=\"recipe-ingredients__unit\">").concat(ing.unit, "</span>\n              </div>\n\n              <div class=\"recipe-ingredients__description\">").concat(ing.description, "</div>  \n            </li>\n          ");
  }).join(''), "\n      </ul>\n\n      <div class=\"recipe-ingredients__directions\">\n        <h3 class=\"recipe-ingredients__title heading-tertiary\">\n          How to cook it\n        </h3>\n\n        <p class=\"recipe-ingredients-text\">\n          This recipe was carefully designed and tested by\n          <span class=\"recipe-ingredients__publisher\">").concat(state.searchByID.recipe.publisher, "</span\n          >. Please check out directions at their website.\n        </p>\n\n        <a href=\"").concat(state.searchByID.recipe.directions, "\" class=\"btn-link noSelect\" target=\"_blank\">\n          <span>Directions</span>\n          <svg class=\"icon recipe-ingredients__icon-arrow-right\">\n            <use xlink:href=\"./img/sprite.svg#icon-arrow-right\"></use>\n          </svg>\n        </a>\n      </div>\n    </div>\n  ");
  if (el.querySelector('.recipe-ingredients') === null) container.insertAdjacentHTML('beforeend', recInfoMarkup);
};

var renderRandomRecipe = function renderRandomRecipe() {
  var mainSection = document.querySelector('.main-section');
  var randomRecipeMarkup = "\n    <div class=\"recipe-container\">\n      <div class=\"recipe-container__image-container noSelect\">\n        <img\n          src=\"".concat(state.randomRecipe[0].imageUrl, "\"\n          class=\"recipe-container__random-image\"\n          id=\"recipe-image\"\n          alt=\"Recipe photo\"\n          data-id=\"").concat(state.randomRecipe[0].id, "\"\n        />\n\n        <div class=\"recipe-container__random-text\">\n          <span class=\"recipe-container__text\">Random recipe</span>\n        </div>\n      </div>\n\n      <div class=\"recipe-container__info\">\n        <div class=\"recipe-container__name-fav\">\n          <span class=\"recipe-container__name\">").concat(state.randomRecipe[0].name, "</span>\n        </div>\n      </div>      \n    </div>\n  ");
  mainSection.insertAdjacentHTML('beforeend', randomRecipeMarkup);
  showRandomRecInfo();
};

var renderSingleFavRec = function renderSingleFavRec(obj) {
  var favSection = document.querySelector('.fav-section');
  var favMarkup = "\n    <div class=\"fav-section__recipe-container noSelect\">\n      <div class=\"fav-section__recipe-image-container\">\n        <a href=\"".concat(obj.direction, "\" target=\"_blank\">\n          <img\n            src=\"").concat(obj.image, "\"\n            class=\"fav-section__recipe-image\"\n            alt=\"Recipe photo\"\n            data-id=\"").concat(obj.recID, "\"\n          />\n        </a>\n    \n        <button class=\"fav-section__remove-fav-button noSelect\">\n          <svg class=\"icon fav-section__remove-fav-icon-cross\">\n            <use xlink:href=\"./img/sprite.svg#icon-x\"></use>\n          </svg>\n        </button>\n      </div>\n      <span class=\"fav-section__recipe-name\">").concat(obj.name, "</span>\n    </div>\n  ");

  if (favSection.querySelector('.fav-section__message-container') !== null) {
    var msg = document.querySelector('.fav-section__message-container');
...
var renderFavRecipes = function renderFavRecipes() {
  var favSection = document.querySelector('.fav-section');
  var localStorage = state.storage;
  var arr = JSON.parse(localStorage.getItem('recipesID'));
  if (arr === null) return;
  arr.map(function (rec) {
    var favMarkup = "\n      <div class=\"fav-section__recipe-container noSelect\">\n        <div class=\"fav-section__recipe-image-container\">\n          <a href=\"".concat(rec.direction, "\" target=\"_blank\">\n            <img \n              src=\"").concat(rec.image, "\"\n              class=\"fav-section__recipe-image\"\n              alt=\"Recipe photo\"\n              data-id=\"").concat(rec.recID, "\"\n            />\n          </a>\n    \n          <button class=\"fav-section__remove-fav-button noSelect\">\n            <svg class=\"icon fav-section__remove-fav-icon-cross\">\n              <use xlink:href=\"./img/sprite.svg#icon-x\"></use>\n            </svg>\n          </button>\n        </div>\n        <span class=\"fav-section__recipe-name\">").concat(rec.name, "</span>\n      </div>\n    ");
...
window.addEventListener('load', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
  return regeneratorRuntime.wrap(function _callee6$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return getRandomQuery();
...
var removeFavRecipe = function removeFavRecipe() {
  var favSection = document.querySelector('.fav-section');
  ...
  if (favSection.querySelector('.fav-section__recipe-container') !== null) {
    favSection.addEventListener('click', function (e) {
      ...
      if (target.classList.contains('fav-section__remove-fav-icon-cross')) {
        var img = target.parentNode.parentNode.querySelector('.fav-section__recipe-image');
        var imgID = img.dataset.id;
        var strFromLS = state.storage.getItem('recipesID');
        var strFromLSParsed = JSON.parse(strFromLS);
        var arr = strFromLSParsed === null ? [] : strFromLSParsed;
        var newArr = [];
        newArr = arr.filter(function (rec) {
          return rec.recID !== imgID;
        });
...
bodyEl.addEventListener('click', function (e) {
  ...
  if (target.classList.contains('svg-path')) {
    if (!icon.classList.contains('recipe-container__fav-icon-heart-active')) {
      var img = icon.parentNode.parentNode.parentNode.previousElementSibling.children[0];
      var imgID = img.dataset.id;
...
var showRecipeInfo = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(handlerQuery, id, el) {
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.next = 2;
            return handlerQuery(id);
  ...
  return function showRecipeInfo(_x6, _x7, _x8) {
    return _ref7.apply(this, arguments);
  };
}();

var searchView = function searchView(handler) {
  headerSearchBtn.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              page = 1;
              resPerPage = 10;
              removeBtn(); // 1) fetch the data and put it in the state

              _context8.next = 6;
              return handler(headerInput.value, renderSpinner);

            case 6:
              // 2) render the data from state
              controlSearchRecipes(); // 3) clear the input
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 8:
              ...
              clearInputField(headerInput); //4 blurring the input
...
var showMoreView = function showMoreView() {
  var btnShowMore = document.querySelector('.show-more__button');
...
var controlSearchRecipes = function controlSearchRecipes() {
  // 1) rendering recipes
  ...
  if (state.search.results > 0) {
    removeSpinner();
    renderRecipesBySearch(state.search.recipes, page, afterBegin); // 2) inserting button

    if (document.querySelector('.show-more') === null) {
      insertButton(); // 3) attaching event to button show more
...
var showRecInfo = function showRecInfo() {
  var recImages = document.querySelectorAll('.recipe-container__image');
  recImages.forEach(function (img) {
    img.addEventListener('click', function (e) {
      var id = e.target.dataset.id;
      var el = e.target.parentNode.parentNode.querySelector('.recipe-container__info');
      var imgContainer = document.querySelector('.recipe-ingredients');
      if (imgContainer === null) showRecipeInfo(getQueryByID, id, el);else imgContainer.parentNode.removeChild(imgContainer);
    });
  });
};

var showRandomRecInfo = function showRandomRecInfo() {
  var recImage = document.querySelector('.recipe-container__random-image');
  recImage.addEventListener('click', function (e) {
    var el = e.target.parentNode.parentNode.querySelector('.recipe-container__info');
    var imgContainer = document.querySelector('.recipe-ingredients');
    if (imgContainer === null) renderRandomRecInfo(el);else imgContainer.parentNode.removeChild(imgContainer);
  });
};

var renderRandomRecInfo = function renderRandomRecInfo(el) {
  var container = el;
  var recInfoMarkup = "\n    <div class=\"recipe-ingredients\">\n      <div class=\"recipe-ingredients__directions\">\n        <h3 class=\"recipe-ingredients__title heading-tertiary\">\n          How to cook it\n        </h3>\n\n        <p class=\"recipe-ingredients-text\">\n          This recipe was carefully designed and tested by\n          <span class=\"recipe-ingredients__publisher\">Check directions</span\n          >. Please check out directions at their website.\n        </p>\n\n        <a href=\"".concat(state.randomRecipe[0].directions, "\" class=\"btn-link noSelect\" target=\"_blank\">\n          <span>Directions</span>\n          <svg class=\"icon recipe-ingredients__icon-arrow-right\">\n            <use xlink:href=\"./img/sprite.svg#icon-arrow-right\"></use>\n          </svg>\n        </a>\n      </div>\n    </div>\n  ");
  if (el.querySelector('.recipe-ingredients') === null) container.insertAdjacentHTML('beforeend', recInfoMarkup);
};
...
init();
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","core-js/stable":"../node_modules/core-js/stable/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
